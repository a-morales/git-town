...
Feature: Fix invalid configuration data
  ...
  Scenario: result
    ...
    And Git Town prints:
      ...
      Ignoring invalid value for "git-town.proposal-breadcrumb": "wrongbreadcrumb"
      Ignoring invalid value for "git-town.proposal-breadcrumb-direction": "wrongbreadcrumbdir"
  ...
  Scenario: undo
    ...
    And local Git setting "git-town.perennial-regex" is now "(per"
    And local Git setting "git-town.proposal-breadcrumb" is now "wrongbreadcrumb"
    And local Git setting "git-town.proposal-breadcrumb-direction" is now "wrongbreadcrumbdir"
