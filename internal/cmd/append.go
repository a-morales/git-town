...
import (
	...
	"github.com/git-town/git-town/v23/internal/vm/interpreter/fullinterpreter"
	"github.com/git-town/git-town/v23/internal/vm/opcodes"
	"github.com/git-town/git-town/v23/internal/vm/optimizer"
...
func appendCmd() *cobra.Command {
	...
	cmd := cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if err := cmp.Or(errAutoResolve, errBeam, errCommit, errCommitMessage, errDetached, errDryRun, errInteractive, errPropose, errPrototype, errPush, errStash, errSync, errVerbose); err != nil {
				return err
			}
